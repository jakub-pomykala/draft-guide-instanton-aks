...
To configure the Semeru Cloud Compiler to handle Just-In-time (JIT) compilation requests from the application you have to set it's [hotspot=enable file=1]`enable` parameter to `true` and also specify the amount of replices you would like.
