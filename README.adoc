...
The service that is used to expose your deployments is [hotspot=createKnative file=0]`KNative`. This means that you can access theese services from the [hotspot=exposed file=0] `exposed` KNative endpoint. 
